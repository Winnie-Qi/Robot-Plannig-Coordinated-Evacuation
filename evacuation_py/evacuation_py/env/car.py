from math import cos, sin, tan, degrees, pi, sqrt
...
class SimpleCar:
    ...
    def __init__(self, env, start_pos=None, end_pos=None, l=0.5, max_phi=0.5):
    ...
    def is_pos_safe(self, pos):
        """ Check pos safety. """
        if sqrt((pos[0]-self.end_pos[0])**2+(pos[1]-self.end_pos[1])**2)<0.8:
            return True
        
        # if pos[1] < 1.7 and pos[0]>7.5 and pos[0]<8.5:
        #     return True
